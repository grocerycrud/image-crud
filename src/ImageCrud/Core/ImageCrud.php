...
use ImageCrud\ThirdParty\ImageMoo;
 ...
 *
 * Copyright (C) 2011 through 2025 John Skoubourdis.
 *
 * LICENSE
 *
...
class ImageCrud {
	...
	function setPrimaryKeyField($field_name)
	{
	...
	private function _load_language()
	{
		...
		foreach($i18n as $handle => $lang_string) {
